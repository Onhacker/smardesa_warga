...
<div class="list-group list-custom-small list-menu warga-menu-list">
    ...
    <?php else: ?>
        ...
        <?php if ($menuIsAuthenticated): ?><a class="<?= nav_is('notifications') ? 'active-nav' : '' ?>" href="<?= site_url('notifikasi') ?>"><i class="fa fa-bell warga-menu-icon is-red"></i><span>Pemberitahuan</span><i class="fa fa-angle-right"></i></a><?php endif; ?>
    <?php endif; ?>
</div>
...
<div class="list-group list-custom-small list-menu warga-menu-list">
    ...
    <?php if ($staffMode): ?><a href="<?= site_url('notifikasi') ?>"><i class="fa fa-bell warga-menu-icon is-red"></i><span>Pemberitahuan</span><i class="fa fa-angle-right"></i></a><?php endif; ?>
    ...
    <?php if ($menuIsAuthenticated): ?><a href="#" class="warga-menu-toggle-row" data-push-toggle-row><i class="fa fa-bell warga-menu-icon is-red"></i><span>Pemberitahuan</span><div class="custom-control small-switch ios-switch warga-menu-toggle-control"><input data-push-toggle type="checkbox" class="ios-input" id="switch-menu-push-notification" aria-label="Aktifkan pemberitahuan"><label class="custom-control-label" for="switch-menu-push-notification"></label></div></a><?php endif; ?>
