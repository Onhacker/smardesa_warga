...
<div class="list-group list-custom-small list-menu warga-menu-list">
    ...
    <a class="<?= $menuContactActive ? 'active-nav' : '' ?>" href="<?= site_url('kontak') ?>"><i class="fa fa-address-book warga-menu-icon is-teal"></i><span>Kontak Kampung</span><i class="fa fa-angle-right"></i></a>
