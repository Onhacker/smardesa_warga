...
<div class="list-group list-custom-small list-menu warga-menu-list">
    ...
    <?php else: ?>
        ...
        <a class="<?= nav_is('layanan') ? 'active-nav' : '' ?>" href="<?= site_url('layanan') ?>"><i class="fa fa-th-large bg-blue-dark color-white"></i><span>Semua Layanan</span><i class="fa fa-angle-right"></i></a>
