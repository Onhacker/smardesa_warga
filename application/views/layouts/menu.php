...
<div class="list-group list-custom-small list-menu warga-menu-list">
    ...
    <a href="#" data-toggle-theme><i class="fa fa-moon warga-menu-icon is-dark"></i><span>Mode Gelap</span><div class="custom-control small-switch ios-switch"><input data-toggle-theme type="checkbox" class="ios-input" id="switch-dark-mode"><label class="custom-control-label" for="switch-dark-mode"></label></div></a>
