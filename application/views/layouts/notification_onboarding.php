...
<div class="warga-notification-onboarding" data-notification-onboarding hidden role="dialog" aria-modal="true" aria-labelledby="warga-notification-onboarding-title" aria-describedby="warga-notification-onboarding-message">
    ...
    <div class="warga-notification-onboarding-panel">
        <span class="warga-notification-onboarding-icon" aria-hidden="true"><i class="fa fa-inbox"></i></span>
        ...
        <div class="warga-notification-onboarding-actions">
            ...
            <button type="button" class="btn bg-blue-dark color-white" data-notification-onboarding-enable><i class="fa fa-inbox" aria-hidden="true"></i><span data-notification-onboarding-enable-label>Izinkan Pemberitahuan</span></button>
        </div>
    </div>
</div>
