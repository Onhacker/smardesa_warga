...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?= base_url('assets/css/warga.min.css') ?>?v=98">
...
<script src="<?= base_url('assets/js/warga.min.js') ?>?v=16"></script>
<script src="<?= base_url('assets/js/community.min.js') ?>?v=9"></script>
