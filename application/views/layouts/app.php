...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?= base_url('assets/css/warga.min.css') ?>?v=80">
    <link rel="stylesheet" href="<?= base_url('assets/css/community.min.css') ?>?v=17">
    <link rel="stylesheet" href="<?= base_url('assets/css/market.css') ?>?v=11">
...
<script>window.SDW={baseUrl:<?= json_encode(base_url()) ?>,csrfName:<?= json_encode($this->security->get_csrf_token_name()) ?>,csrfHash:<?= json_encode($this->security->get_csrf_hash()) ?>,serviceWorkerUrl:<?= json_encode(base_url('service-worker.js') . '?v=42') ?>,serviceWorkerScope:<?= json_encode(base_url()) ?>};</script>
...
<script src="<?= base_url('assets/js/market.js') ?>?v=2"></script>
</body>
</html>
