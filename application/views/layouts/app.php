...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?= base_url('assets/css/warga.min.css') ?>?v=108">
    <link rel="stylesheet" href="<?= base_url('assets/css/community.min.css') ?>?v=21">
