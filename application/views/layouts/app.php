...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?= base_url('assets/css/warga.min.css') ?>?v=110">
    <link rel="stylesheet" href="<?= base_url('assets/css/community.min.css') ?>?v=24">
...
<div id="page">
    <header class="header header-fixed header-logo-center header-auto-show">
        ...
        <a href="<?= $notificationUrl ?>" class="header-icon <?= $notificationHeaderClass ?> warga-header-notification" aria-label="<?= e($notificationLabel) ?>"><i class="fas fa-bell" aria-hidden="true"></i><span class="badge bg-red-dark" data-notification-count hidden></span></a>
    </header>
...
<script src="<?= base_url('assets/js/warga.min.js') ?>?v=21"></script>
<script src="<?= base_url('assets/js/community.min.js') ?>?v=15"></script>
