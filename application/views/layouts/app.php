...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?= base_url('assets/css/warga.min.css') ?>?v=105">
...
<script src="<?= base_url('assets/js/community.min.js') ?>?v=13"></script>
