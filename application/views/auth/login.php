...
<script>window.SDW={baseUrl:<?= json_encode(base_url()) ?>,serviceWorkerUrl:<?= json_encode(base_url('service-worker.js') . '?v=69') ?>,serviceWorkerScope:<?= json_encode(base_url()) ?>};</script>
