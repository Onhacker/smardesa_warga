...
<article class="warga-legal-page">
    ...
    <div class="warga-legal-card">
        ...
        <section aria-labelledby="deletion-data-title">
            ...
            <p>Setelah permintaan disetujui, data yang tidak wajib menjadi arsip akan dihapus atau dianonimkan. Data ini mencakup kredensial untuk masuk, profil dan kontak akun, sesi serta langganan pemberitahuan perangkat, dan konten Pasar Dapulik yang masih berada di bawah kendali akun.</p>
        </section>
