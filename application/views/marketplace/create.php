...
<div class="marketplace-page marketplace-form-page">
    ...
    <section class="card card-style market-form-card">
        <div class="content">
            ...
            <form method="post" action="<?= site_url('pasar/simpan') ?>" enctype="multipart/form-data" data-market-product-form>
                <?= csrf_field() ?>
                ...
                <label class="market-form-field" for="market-product-price"><span>Harga (Rupiah)</span><span class="market-money-input"><b>Rp</b><input type="number" id="market-product-price" name="price" value="<?= e($value('price')) ?>" required min="0" max="999999999999999" step="1" inputmode="numeric" placeholder="0" data-market-price></span><?php if ($error('price')): ?><small class="market-form-error"><?= e($error('price')) ?></small><?php endif; ?></label>
