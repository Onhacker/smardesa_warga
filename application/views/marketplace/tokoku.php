            ...
            <div class="market-product-grid market-tokoku-grid">
                <?php foreach ($products as $product): ?>
                    ...
                    <article class="market-product-card market-tokoku-product-card">
                        ...
                        <div class="market-tokoku-product-actions"><a href="<?= site_url('pasar/produk/' . rawurlencode($id) . '/ubah') ?>"><i class="fa fa-pen" aria-hidden="true"></i> Edit</a><?php if ($status !== 'archived'): ?><form method="post" action="<?= site_url('pasar/produk/' . rawurlencode($id) . '/arsipkan') ?>" data-disable-submit><?= csrf_field() ?><button type="submit"><i class="fa fa-archive" aria-hidden="true"></i> Arsipkan</button></form><?php endif; ?></div>
                    </article>
                <?php endforeach; ?>
            </div>
        <?php endif; ?>
