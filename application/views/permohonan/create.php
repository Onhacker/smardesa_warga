...
<form method="post" action="<?= site_url('permohonan/simpan') ?>" enctype="multipart/form-data" class="warga-request-form" data-request-form data-services="<?= warga_json($services) ?>" data-disable-submit>
    ...
    <section class="card card-style warga-form-card d-none" data-dynamic-form-section><div class="content">
        <div class="warga-form-title"><span>3</span><div><h2>Data Tambahan</h2><p data-dynamic-form-description>Lengkapi isian yang dibutuhkan untuk layanan ini.</p></div></div>
        <div class="warga-dynamic-fields" data-form-fields></div>
    </div></section>

    <section class="card card-style warga-form-card"><div class="content">
        <div class="warga-form-title"><span data-supporting-step>4</span><div><h2>Berkas Pendukung</h2><p>Unggah foto atau PDF tambahan yang jelas.</p></div></div>
