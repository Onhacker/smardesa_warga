...
class Api extends Public_Controller
{
    public function health()
    {
        ...
        $this->output->set_content_type('application/json', 'utf-8')->set_output(json_encode(array('success' => TRUE, 'service' => $this->branding['nama_sistem'] . ' API', 'status' => 'ready', 'time' => date('c')), JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES));
    }
}
