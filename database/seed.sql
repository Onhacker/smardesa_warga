...
-- Pilot tenant only. Replace the code/name with the official village data.
...
VALUES ('00000000-0000-4000-8000-000000000001', '91', 'Papua', '9102', 'Jayawijaya', '910205', 'Asolagama', 'DEMO-ARABODA', 'Kampung Araboda', 'active')
