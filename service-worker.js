...
const SDW_CACHE = SDW_CACHE_PREFIX + '2026-09-05-community-ui-14';
...
const precache = [
  ...
  'assets/css/warga.min.css?v=68',
  'assets/v22/scripts/bootstrap.min.js',
  'assets/v22/scripts/custom.min.js?v=2',
  'assets/js/warga.min.js?v=13',
  'assets/js/community.min.js?v=6',
  'assets/css/community.min.css?v=12'
